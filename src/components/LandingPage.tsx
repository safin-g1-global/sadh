  ...
  const features = [
    {
      ...
      description: "Comprehensive evaluation of your cardiovascular risk factors"
    },
    {
      icon: Shield,
  ...
  const testimonials = [
    {
      name: "Dr. Sarah Ahmed",
      role: "Cardiologist",
      quote: "This tool provides invaluable insights for early detection and prevention in our community."
    },
    {
      name: "Raj Patel",
      role: "Patient",
      quote: "The assessment helped me understand my risks and take proactive steps for my health."
    }
  ];
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-white/90 leading-relaxed">
                  Take control of your health with our comprehensive diabetes and heart health screening tool, specifically designed for the South Asian community.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button 
                  variant="outline" 
                  size="lg"
                  className="border-white text-white hover:bg-white hover:text-blue-600 text-lg px-8 py-6 rounded-full transition-all duration-300"
                >
                  Learn More
                </Button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our evidence-based assessment tools help identify your risk factors and provide personalized recommendations for better health outcomes.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl">
              <div className="text-center mb-8">
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Health Statistics</h3>
                <p className="text-gray-600">South Asian Community Health Risks</p>
              </div>
              <div className="space-y-6">
                <div className="bg-red-50 rounded-xl p-6">
                  <div className="text-3xl font-bold text-red-600 mb-2">2x Higher</div>
                  <p className="text-gray-700">Risk of Type 2 Diabetes</p>
                </div>
                <div className="bg-orange-50 rounded-xl p-6">
                  <div className="text-3xl font-bold text-orange-600 mb-2">40% Higher</div>
                  <p className="text-gray-700">Risk of Heart Disease</p>
                </div>
                <div className="bg-green-50 rounded-xl p-6">
                  <div className="text-3xl font-bold text-green-600 mb-2">85% Success</div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-white/90">
            Join thousands who have already taken control of their health with our comprehensive assessment tool.
          </p>
          <Button 
            onClick={() => navigate('/assessment')}
            size="lg"
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-xl font-bold">South Asian Health Center</span>
              </div>
              <p className="text-gray-400">
                Dedicated to improving health outcomes in the South Asian community through early detection and prevention.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 South Asian Center for Diabetes and Heart Health. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
